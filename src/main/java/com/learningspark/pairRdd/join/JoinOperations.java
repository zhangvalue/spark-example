package com.learningspark.pairRdd.join;
...
public class JoinOperations {
	...
	public static void main(String[] args) {
		...
		leftOuterJoin.saveAsTextFile("out/age_address_left_out_join");
		
		JavaPairRDD<String, Tuple2<Optional<Integer>, String>> rightOuterJoin = ages.rightOuterJoin(addresses);
		rightOuterJoin.saveAsTextFile("out/age_address_right_out_join");
